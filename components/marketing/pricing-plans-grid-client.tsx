...
const FEATURES = [
  ...
  "Revision path included",
];

export function PricingPlansGridClient({ categories }: { categories: PricingTabCategory[] }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#f7f7fb] px-4 py-10 text-slate-950 dark:bg-[#050814] dark:text-white md:px-8 md:py-14">
      ...
      <div className="page-shell relative z-10">
                ...
                <button
                  ...
                  className={[
                    ...
                    isActive
                      ...
                      : "bg-slate-100 text-slate-500 hover:bg-slate-200 hover:text-slate-950 dark:bg-white/[0.055] dark:text-white/70 dark:hover:bg-white/[0.09] dark:hover:text-white",
                  ].join(" ")}
                >
                  {cat.label}
                </button>
        ...
        <p className="mx-auto mt-6 max-w-2xl text-center text-xs leading-6 text-slate-500 dark:text-white/60">
          Starting prices shown. Final quote is calculated at order time based on
          design complexity, stitch count, size, rush delivery, and quantity.
          Bulk discounts apply automatically at 5+ units.
        </p>
      </div>
    </section>
  );
...
function PricingCard({
  ...
  plan: PricingTabCategory["plans"][number];
  index: number;
      ...
      >
        ...
        <CardContent className="relative z-10 flex h-full flex-col p-5 sm:p-6">
          <div className="text-center">
            ...
            <h3 className="line-clamp-2 text-lg font-black uppercase tracking-[0.06em] text-indigo-700 dark:text-indigo-300">
              {plan.title}
            </h3>
