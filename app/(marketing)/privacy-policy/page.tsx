    ...
    <div className="bg-[var(--bg)] text-[var(--txt)] overflow-x-hidden">
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-[var(--txt2)] leading-relaxed">
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">3. Design Files &amp; Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">4. Data Storage &amp; Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">5. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">6. Third-Party Services</h2>
            <p>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">7. Your Rights</h2>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">8. Policy Updates</h2>
            <p>
          ...
          <section>
            <h2 className="font-jakarta font-bold text-lg text-[var(--txt)] mb-3">9. Contact</h2>
            <p>
