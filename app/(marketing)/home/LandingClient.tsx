  ...
  <div className="px-3 pt-3 flex items-center gap-2 bg-gradient-to-r from-[#2563EB] via-[#1D4ED8] to-[#0F3460] shadow-[0_1px_8px_rgba(37,99,235,0.2)]" style={{ paddingBottom: "env(safe-area-inset-bottom, 12px)" }}>
    <div className="relative flex-shrink-0">
      ...
      <div className="absolute -top-12 left-1/2 -translate-x-4 z-50">
        <div className="bg-[#25D366] text-white text-[11px] font-bold px-3 py-1.5 rounded-xl whitespace-nowrap shadow-lg relative"
          style={{ animation: "bounceUp 2s ease-in-out infinite" }}>
          GET QUOTE in 5 min
          <div className="absolute -bottom-1.5 left-3 w-3 h-3 bg-[#25D366] rotate-45" />
        </div>
      </div>
      <a
    ...
    <Link href="/register" className="flex-1">
      <Button
        variant="grad"
        size="md"
        className="w-full !h-11 !py-0 !text-[13px] !font-bold !rounded-2xl !shadow-md !ring-1 !ring-inset !ring-white"
      >
        Register
      </Button>
    </Link>
