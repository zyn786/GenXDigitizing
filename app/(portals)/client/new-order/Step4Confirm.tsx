...
export function Step4Confirm({sel,serviceName,selTurn,fmt,extras,designName,files,w,h,col,notes,qty,stitchCount,instructions,totalPrice,busy,placeOrder,setStep,couponCode,setCouponCode,appliedCoupon,discount,isApplying,couponError,applyCoupon,removeCoupon}:any){
