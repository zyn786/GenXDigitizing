...
const SEED_POSTS = [
  {
    ...
    content: {
      ...
      faqs: [
        ...
        { q: "What file formats should I request from a digitizer?", a: "DST is the universal standard and works on nearly every commercial machine. We recommend also requesting PES (stores colors) and EMB (preserves editing capability). All formats are included free with every genxdigitizing order." },
